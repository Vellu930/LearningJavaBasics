...
public class FunctionCallAlphabet {
	public static void main(String[] args) {
		...
		e(5); // pass it the number of letters to display (9)
		f("Fellow citizen"); // displays the word you pass it beginning with "F"
		g(); // returns the word to be displayed
		h(2); // tell it how many times to display the word (1)
		System.out.println();

		i(6); // pass it any integer and it will display a word beginning
		// with I
		j(2); // returns a different word depending on what you pass it
		// (1-3)
		k(); // displays a word beginning with K
		l(true, false); // displays a different word depending on the two booleans
		// you pass it
		m(false, true); // displays a different word depending on the two booleans
		// you pass it
		n("Nothing"); // displays the word you pass it beginning with "N"
		o(); // displays a word beginning with O and returns a useless
		// value
		p(); // returns the word to be displayed
		q(); // displays the word
		System.out.println();

		r(true); // returns a different word depending on if you pass it
		// 'true' or 'false'
		...
		// ???? w( ???? ); // pass it any integer and it will display a word beginning
		// with W
		// ???? x( ???? ); // returns a different word depending on what you pass it
		// (1-2)
		// ???? y( ???? ); // displays a word beginning with Y
		// ???? z( ???? ); // returns a different word depending on which two boolean
		// values you pass it
		System.out.println();
	}
